          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                <h1>Categories</h1>
                <p class="mb-0">Choose categories you want</p>
                <p class="mb-0"><span><a href="index.php">Home</a></span><span>/ Categories</span></p>
              </div>
            </div>
          ...
          <div class="col-lg-8">
            ...
            <div class="row">
                ...
                if(isset($_GET["category"])){
                    echo($obj->categoryproductDisplay($_GET["category"]));
                }
                else if(isset($_GET["search_query"]) && isset($_GET["categories"])){
                    echo($obj->catsearchCardDisplay($_GET["search_query"],$_GET["categories"]));
                }
                ?>
            ...
            <div class="mb-5">
              ...
              <form action="#" method="GET">
                <div class="form-group">
                  <input type="text" name="search_query" placeholder="What are you looking for?" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input type="submit" name="search_category" class="btn btn-primary btn-block rounded" value="Search">
                  </div>
              </form>
            </div>
