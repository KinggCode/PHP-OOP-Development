        ...
        <div class="row">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-6 mb-3 mb-md-0">
                  ...
                  <input type="text" id="fname" name="user_fname" class="form-control" placeholder="Firstname">
                </div>
                <div class="col-md-6">
                  <label class="text-black" for="lname">Last Name</label>
                  <input type="text" id="lname" name="user_lname" class="form-control" placeholder="Last Name">
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  ...
                  <input type="subject" id="subject" name="mail_subject" class="form-control" placeholder="Subject">
                </div>
              </div>
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" name="mail_message" cols="30" rows="7" class="form-control" placeholder="Write your notes or questions here..."></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit_msg" value="Send Message" class="btn btn-primary py-2 px-4 text-white">
                </div>
              </div>
          ...
          <div class="col-md-5"  data-aos="fade" data-aos-delay="100">
            ...
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">Ashesi University, 1 University Avenue, Accra - Ghana</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="+233207973714">+233 0207973714</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="eugene.parker@ashesi.edu.gh">eugene.parker@ashesi.edu.gh</a></p>
